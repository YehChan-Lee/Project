...
public class ShopVo {
	...
	private Date shop_date;			// 사업가 신청 날짜			NULL
	private String hash_tag;		// 해시태그				NULL
	private String shop_state;		// 사업자 승인					NOT NULL
	...
	public ShopVo(String shop_id, String user_email, int shop_idx, String shop_title, String shop_addr,
			...
			String shop_photo, String shop_review, Date shop_date, String hash_tag, String shop_state) {
	...
	public String toString() {
		return "ShopVo [shop_id=" + shop_id + ", user_email=" + user_email + ", shop_idx=" + shop_idx + ", shop_title="
				...
				+ shop_close + ", shop_photo=" + shop_photo + ", shop_review=" + shop_review + ", shop_date="
				+ shop_date + ", hash_tag=" + hash_tag + ", shop_state=" + shop_state + "]";
	}
