			...
			.ready(
					function() {
						...
						$("#nav_genre > div.box > ul > li:nth-child(2)>input").on('click', function() {
							...
							if(value) {
								cnt += 1;
								if(cnt > 0) {$(".section_detail_genre").show();}
								$("div.dg_popup>ul:nth-child(1)").show();
							} else {
								cnt -= 1;
								$("div.dg_popup>ul:nth-child(1)").hide();
							}
							if(cnt == 0) {$(".section_detail_genre").hide();}
							console.log(cnt);
						});
						...
						$(".confirm_btn").click(
								function(e) {
									...
									$("#popup_body").hide();
									$("#nav_btn").siblings().removeClass(
											'focus');
									$(".section_price").siblings().removeClass(
											'is-open');
									$(".filters_popup").hide();
						...
						$(".section_place").click(
								function(e) {
									$(".filters_popup").hide();
									if ($("#nav_area").attr("class").indexOf(
											"focus") == -1) {
										$("#nav_city>ul").hide();
										$('#nav_area>.box').show();
						...
						$(".section_genre").click(
								function(e) {
									$(".filters_popup").hide();
									if ($("#nav_genre").attr("class").indexOf(
											"focus") == -1) {
										$("#nav_city>ul").hide();
										$('#nav_genre>.box').show();
										// focus주고 형제들은 focus지우기
										$("#nav_genre").addClass('focus')
												.siblings()
												.removeClass('focus');
										// 배경 어둡게
										$("#nav_shading.shading_bg").show();
						...
						// 세부음식 선택
						$(".section_detail_genre").click(
								function(e) {
									$(".filters_popup").hide();
									$('.section_detail_genre>.filters_popup')
											.show();
									$('#nav_wrap').css('z-index', 30);
									// focus주고 형제들은 focus지우기
									$(this).addClass('is-open').siblings()
											.removeClass('is-open');
									// 배경 어둡게
									$(".shading_bg").show();
									e.stopPropagation();
						...
						$(".section_add_info").click(
								function(e) {
									$(".filters_popup").hide();
									$('.section_add_info>.filters_popup')
											.show();
									$('#nav_wrap').css('z-index', 30);
									// focus주고 형제들은 focus지우기
									$(this).addClass('is-open').siblings()
						...
						/* 팝업 데이터 쓰기 */
						$(
								'.section_price > div.filters_popup > ul > li > input')
								.change(
										function() {
											console.log(this);
											...
											var dpValue = $(this).next("label")
													.text()
													+ " (2인 기준)";
											if ($(this).is(":checked") === false
													|| $(this).attr('id') == 'price_all')
												dpValue = "예산 (2인 기준)";

											$(".section_price > span").html(
													dpValue);
										});
						/**/
						$(
								'.section_add_info > .filters_popup > ul > li > input:not([id$=all])')
								.change(
										function() {
											var state = $(this).is(":checked");
											var id = $(this).val();
											var str = $(this).next("label")
													.text();
												...
												$("#add_info_sel_list")
														.append(
																"<li data-id='"
																		...
																		+ str
																		+ "</span>"
																		+ "<div class='iconDelete' style='background-image: url(<c:url value="${path}/res/image/menubar/deleteBtn.png"/>)'></div>"
																		+ "</li>");
											} else {
												$("li[data-id=" + md5(id) + "]")
														.remove();
											...
											var length = $(this)
													.closest("ul")
													.find(
															"input:checked:not([id$=all])").length;
											...
											$(".section_add_info > span").html(
													length);
										});
						/**/
						$(
								'.section_table > .filters_popup > ul > li > input:not([id$=all])')
								.change(
										function() {
											var state = $(this).is(":checked");
											var id = $(this).val();
											...
											$(".section_table > span").html(
													length);

										});
						/**/
						$(
								'.section_liquor > .filters_popup > ul > li > input:not([id$=all])')
								.change(
										function() {
											var state = $(this).is(":checked");
											var id = $(this).val();
						...
						$('.section_detail_genre > .filters_popup > div.dg_popup > ul > li > input:not([id$=all])').change(function() {
							...
							if (state) { 
								$("#detail_genre_sel_list").append("<li data-id='"+ md5(id)+ "'><span>"+ str+ "</span>"
																		+ "<div class='iconDelete' style='background-image: url(<c:url value="${path}/res/image/menubar/deleteBtn.png"/>)'></div>"
																		+ "</li>");
							} else {
						...
						$(
								"#filter_sidebar > div.filters div.filters_popup > ul > li > input:not([id$=all])")
								.change(
										function() {
											var all = $(this)
													.closest("ul")
						...
						$("div.dg_popup > ul > li > input:not([id$=all])")
								.change(
										function() {
											var all = $(this)
													.closest("ul")
						...
						$(
								'#c9f0f895fb98ab9159f51fd0297e236d_all, #6512bd43d9caa6e02c990b0a82652dca_all, #b53b3a3d6ab90ce0268229151c9bde11_all, #8e296a067a37563370ded05f5a3bf3ec_all, #45c48cce2e2d7fbdea1afc51c7c6ad26_all')
								.change(
										function() {
											var state = $(this).is(":checked");
											var siblings = $(this)
											...
											siblings.children("input").prop(
													'checked', state).change();
										});

						// selected_list delete
						$("ul#add_info_sel_list").delegate(
								"li",
								"click",
								function(e) {
									e.stopPropagation();
									$("input#" + $(this).data('id')).prop(
											"checked", false).change();
								});

						// selected_list delete
						$("ul#table_sel_list").delegate(
								"li",
								"click",
								function(e) {
									e.stopPropagation();
						...
						// selected_list delete
						$("ul#detail_genre_sel_list").delegate(
								"li",
								"click",
								function(e) {
									e.stopPropagation();
						...
						/* 체크박스 전체 클릭 */
						$('#additional_all').change(
								function() {
									var state = $(this).is(":checked");
									var siblings = $(this).closest('ul').find(
											'li').siblings();
									...
									siblings.children("input").prop('checked',
											state).change();
								});
				...
				<div class="filters_popup">
					...
					<div class="dg_popup">
						<ul data-genre="c9f0f895fb98ab9159f51fd0297e236d">
							...
							<li><input type="checkbox"
								id="eccbc87e4b5ce2fe28308fd9f2a7baf3" value="3"><label
								for="eccbc87e4b5ce2fe28308fd9f2a7baf3" class="">국물요리</label></li>
							<li><input type="checkbox"
								id="a87ff679a2f3e71d9181a67b7542122c" value="4"><label
								for="a87ff679a2f3e71d9181a67b7542122c" class="">찜요리</label></li>
							<li><input type="checkbox"
								id="02e74f10e0327ad868d138f2b4fdd6f0" value="27"><label
								for="02e74f10e0327ad868d138f2b4fdd6f0" class="">구이요리</label></li>
							<li><input type="checkbox"
								id="33e75ff09dd601bbe69f351039152189" value="28"><label
								for="33e75ff09dd601bbe69f351039152189" class="">면요리</label></li>
							<li><input type="checkbox"
								id="e4da3b7fbbce2345d7772b0674a318d5" value="5"><label
								for="e4da3b7fbbce2345d7772b0674a318d5" class="">볶음요리</label></li>
							<li><input type="checkbox"
								id="98dce83da57b0395e163467c9dae521b" value="93"><label
								for="98dce83da57b0395e163467c9dae521b" class="">해산물요리</label></li>
							<li><input type="checkbox"
								id="1679091c5a880faf6fb5e6087eb1b2dc" value="6"><label
								for="1679091c5a880faf6fb5e6087eb1b2dc" class="">반상</label></li>
							<li><input type="checkbox"
								id="7eabe3a1649ffa2b3ff8c02ebfd5659f" value="206"><label
						...
						<ul data-genre="6512bd43d9caa6e02c990b0a82652dca">
							...
							<li><input type="checkbox"
								id="3295c76acbf4caaed33c36b1b5fc2cb1" value="66"><label
								for="3295c76acbf4caaed33c36b1b5fc2cb1" class="">프랑스식</label></li>
							<li><input type="checkbox"
								id="9bf31c7ff062936a96d3c8bd1f8f2ff3" value="15"><label
								for="9bf31c7ff062936a96d3c8bd1f8f2ff3" class="">이탈리아식</label></li>
							<li><input type="checkbox"
								id="70efdf2ec9b086079795c442636b55fb" value="17"><label
								for="70efdf2ec9b086079795c442636b55fb" class="">미국식</label></li>
							<li><input type="checkbox"
								id="072b030ba126b2f4b2374f342be9ed44" value="60"><label
								for="072b030ba126b2f4b2374f342be9ed44" class="">멕시코식</label></li>
							<li><input type="checkbox"
								id="b6d767d2f8ed5d21a44b0e5886680cb9" value="22"><label
								for="b6d767d2f8ed5d21a44b0e5886680cb9" class="">스페인식</label></li>
							<li><input type="checkbox"
								id="d3d9446802a44259755d38e6d163e820" value="10"><label
						...
						<ul data-genre="b53b3a3d6ab90ce0268229151c9bde11">
							...
							<li><input type="checkbox"
								id="ad61ab143223efbc24c7d2583be69251" value="74"><label
								for="ad61ab143223efbc24c7d2583be69251" class="">인도식</label></li>
							<li><input type="checkbox"
								id="7cbbc409ec990f19c78c75bd1e06f215" value="70"><label
								for="7cbbc409ec990f19c78c75bd1e06f215" class="">태국식</label></li>
							<li><input type="checkbox"
								id="9f61408e3afb633e50cdf1b20de6f466" value="56"><label
								for="9f61408e3afb633e50cdf1b20de6f466" class="">베트남식</label></li>
							<li><input type="checkbox"
								id="a684eceee76fc522773286a895bc8436" value="54"><label
						...
						<ul data-genre="8e296a067a37563370ded05f5a3bf3ec">
							...
							<li><input type="checkbox"
								id="6ea9ab1baa0efb9e19094440c317e21b" value="29"><label
								for="6ea9ab1baa0efb9e19094440c317e21b" class="">소고기</label></li>
							<li><input type="checkbox"
								id="4e732ced3463d06de0ca9a15b6153677" value="26"><label
								for="4e732ced3463d06de0ca9a15b6153677" class="">돼지고기</label></li>
							<li><input type="checkbox"
								id="812b4ba287f5ee0bc9d43bbf5bbe87fb" value="95"><label
								for="812b4ba287f5ee0bc9d43bbf5bbe87fb" class="">양고기</label></li>
							<li><input type="checkbox"
								id="26657d5ff9020d2abefe558796b99584" value="96"><label
								for="26657d5ff9020d2abefe558796b99584" class="">해산물</label></li>
							<li><input type="checkbox"
								id="eb163727917cbba1eea208541a643e74" value="211"><label
						...
						<ul data-genre="45c48cce2e2d7fbdea1afc51c7c6ad26">
							...
							<li><input type="checkbox"
								id="c51ce410c124a10e0db5e4b97fc2af39" value="13"><label
								for="c51ce410c124a10e0db5e4b97fc2af39" class="">바</label></li>
							<li><input type="checkbox"
								id="44f683a84163b3523afe57c2e008bc8c" value="62"><label
								for="44f683a84163b3523afe57c2e008bc8c" class="">펍</label></li>
							<li><input type="checkbox"
								id="8f14e45fceea167a5a36dedd4bea2543" value="7"><label
